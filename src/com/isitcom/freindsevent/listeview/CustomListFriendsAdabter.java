...
public class CustomListFriendsAdabter extends BaseAdapter {

	private ArrayList<UserListSearchView> listData;

	private LayoutInflater layoutInflater;

	public CustomListFriendsAdabter(Context context, ArrayList<UserListSearchView> listData) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = layoutInflater.inflate(R.layout.templatelistsearchsview, null);
